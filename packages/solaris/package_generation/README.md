Automated Verprotect Solaris packages using vagrant
==============================================

In this repository, you can find the necessary tools to build a Verprotect package for Solaris 10 and 11 using vagrant.

## Tools needed to build the package

To build a Verprotect package you need to install the following tools:
...
2. Bring the machine up `vagrant [OPTION] ... up solaris10/solaris11`:
    ...
    ```
    * To build a verprotect-agent package for Solaris 10 from branch v3.9.0 sources:
