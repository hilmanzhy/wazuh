...
| `-r`, `--readytoreview` | Run all the quality checks needed to create a PR. Example: `python3 build.py -r <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `-d`, `--readytoreviewandclean` | Run all the quality checks needed to create a PR. Example: `python3 build.py -d <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `-m`, `--make`          | Compile the lib. Example: `python3 build.py -m <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `-t`, `--tests`         | Run tests (should be configured with TEST=on). Example: `python3 build.py -t <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `-c`, `--coverage`      | Collect tests coverage and generates report. Example: `python3 build.py -c <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `-v`, `--valgrind`      | Run valgrind on tests. Example: `python3 build.py -v <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `--clean`               | Clean the lib. Example: `python3 build.py --clean <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `--cppcheck`            | Run cppcheck on the code. Example: `python3 build.py --cppcheck <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `--asan`                | Run ASAN on the code. Example: `python3 build.py --asan <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `--scheck`              | Run AStyle on the code for checking purposes. Example: `python3 build.py --scheck <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
| `--sformat`             | Run AStyle on the code formatting the needed files. Example: `python3 build.py --sformat <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
...
| `--deleteLogs` | Clean log results to some module. Example: `python3 build.py --deleteLogs <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |

Ready to review checks:
  1. Runs cppcheck on <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd> folder.
  2. Compiles <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>.
  3. Runs <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd> UTs.
  4. Runs valgrind on <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd> UTs.
  5. Runs code coverage on <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd> tests and generates coverage reports.
  6. Runs AStyle on <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>.
  7. Runs ASAN on <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>.
...
Address sanitizer checks:
  1. Clean previous builds <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd> folder.
  2. Compiles with address sanitizers flags<verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>.
  3. Runs smoke tests <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>
  4. Runs valgrind on <verprotect_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd> UTs.
