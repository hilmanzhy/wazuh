...
int AR_ReadConfig(const char *cfgfile)
{
    ...
    fprintf(fp, "restart-ossec0 - restart-ossec.sh - 0\nrestart-ossec0 - restart-ossec.cmd - 0\n"
                "restart-verprotect0 - restart-ossec.sh - 0\nrestart-verprotect0 - restart-ossec.cmd - 0\n"
                "restart-verprotect0 - restart-verprotect - 0\nrestart-verprotect0 - restart-verprotect.exe - 0\n");
    fclose(fp);
