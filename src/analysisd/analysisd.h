...
#define VERPROTECT_SERVER    "verprotect-server"
#define MAX_DECODER_ORDER_SIZE  1024

extern OSHash *fim_agentinfo;
extern int num_rule_matching_threads;

#define FIM_MAX_VERPROTECT_DB_ATTEMPS 5
#define SYS_MAX_VERPROTECT_DB_ATTEMPS 5
#define PM_MAX_VERPROTECT_DB_ATTEMPS 5
