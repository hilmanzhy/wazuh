 ...
 * @param sock Verprotect DB socket
 */
...
void w_inc_decoded_by_component_events(const char *component, const char *agent_id) {
    if (component != NULL) {
        if (!strcmp(component, "verprotect-agent")) {
            w_inc_agent_decoded_events(agent_id);
        } else if (!strcmp(component, "verprotect-agentlessd")) {
            w_inc_agentless_decoded_events(agent_id);
        } else if (!strcmp(component, "verprotect-monitord")) {
            w_inc_monitor_decoded_events(agent_id);
        } else if (!strcmp(component, "verprotect-remoted")) {
        ...
        } else if (!strcmp(component, "aws-s3") || !strcmp(component, "Verprotect-AWS")) {
        ...
        } else if (!strcmp(component, "docker-listener") || !strcmp(component, "Verprotect-Docker")) {
            w_inc_modules_docker_decoded_events(agent_id);
        } else if (!strcmp(component, "gcp-pubsub") || !strcmp(component, "gcp-bucket") || !strcmp(component, "Verprotect-GCloud")) {
