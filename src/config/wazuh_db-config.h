...
#ifndef VERPROTECT_DB_CONFIG_H
#define VERPROTECT_DB_CONFIG_H
 ...
 */
int Read_VerprotectDB(const OS_XML *xml, XML_NODE chld_node);

/**
 * @brief This method will read the "backup" configuration block of Verprotect-DB.
 *
 * @param xml The configuration file to read.
