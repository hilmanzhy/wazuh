...
/* Some global names */
#define __ossec_name    "Verprotect"
#define __ossec_version "v4.10.0"
#define __author        "Verprotect Inc."
...
// Verprotect home environment variable
#define VERPROTECT_HOME_ENV  "VERPROTECT_HOME"
