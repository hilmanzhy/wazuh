...
public:
    ...
    {
        std::cout << "\nUsage: verprotect-keystore <option(s)>\n"
                  << "Options:\n"
                  ...
                  << "\nExample:"
                  << "\n\t./verprotect-keystore -f indexer -k username -v admin\n"
                  << "\n\t./verprotect-keystore -f indexer -k password -vp /path/to/file.txt\n"
                  << "\n\t./verprotect-keystore -f indexer -k password < /path/to/file.txt\n"
                  << "\n\techo 'pass' | ./verprotect-keystore -f indexer -k password\n"
                  << "\n\tcat /path/to/file.txt | ./verprotect-keystore -f indexer -k password\n"
                  << std::endl;
    }
