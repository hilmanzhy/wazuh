...
#include <shared.h>
#include "../../../verprotect_modules/wmodules_def.h"
...
void test_wm_sync_group_file_error_agent_id(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "verprotect-modulesd:database");
...
void test_sync_keys_with_wdb_insert(void **state) {
    ...
    expect_string(__wrap__mtdebug2, tag, "verprotect-modulesd:database");
...
void test_sync_keys_with_wdb_insert_delete(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "verprotect-modulesd:database");
    expect_string(__wrap__mtdebug1, formatted_msg, "Could not remove the verprotect-db DB of the agent 1.");
...
void test_sync_keys_with_wdb_null(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "verprotect-modulesd:database");
